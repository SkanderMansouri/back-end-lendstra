...
/**
 * REST controller for managing {@link com.hackathon.hackthefuture.domain.Demand}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DemandResource {
    ...
    public ResponseEntity<Demand> updateDemand(@RequestBody Demand demand) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, demand.getId().toString()))
            .body(result);
    }
