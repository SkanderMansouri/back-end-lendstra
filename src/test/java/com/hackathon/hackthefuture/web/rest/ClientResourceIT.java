...
import com.hackathon.hackthefuture.service.ClientService;
...
public class ClientResourceIT {
    ...
    private static final Double DEFAULT_LOANED = 1D;
    private static final Double UPDATED_LOANED = 2D;

    private static final Double DEFAULT_PAID = 1D;
    private static final Double UPDATED_PAID = 2D;

    private static final Double DEFAULT_VALIDED = 1D;
    private static final Double UPDATED_VALIDED = 2D;
    ...
    public void createClient() throws Exception {
        ...
        assertThat(testClient.getJob()).isEqualTo(DEFAULT_JOB);
        ...
        assertThat(testClient.getLoaned()).isEqualTo(DEFAULT_LOANED);
        assertThat(testClient.getPaid()).isEqualTo(DEFAULT_PAID);
        assertThat(testClient.getValided()).isEqualTo(DEFAULT_VALIDED);
    }
    ...
    public void getAllClients() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].loaned").value(hasItem(DEFAULT_LOANED.doubleValue())))
            .andExpect(jsonPath("$.[*].paid").value(hasItem(DEFAULT_PAID.doubleValue())))
            .andExpect(jsonPath("$.[*].valided").value(hasItem(DEFAULT_VALIDED.doubleValue())));
    }
    ...
    public void getClient() throws Exception {
        ...
        restClientMockMvc.perform(get("/api/clients/{id}", client.getId()))
            ...
            .andExpect(jsonPath("$.loaned").value(DEFAULT_LOANED.doubleValue()))
            .andExpect(jsonPath("$.paid").value(DEFAULT_PAID.doubleValue()))
            .andExpect(jsonPath("$.valided").value(DEFAULT_VALIDED.doubleValue()));
    }
    ...
    public void updateClient() throws Exception {
        ...
        assertThat(testClient.getJob()).isEqualTo(UPDATED_JOB);
        ...
        assertThat(testClient.getLoaned()).isEqualTo(UPDATED_LOANED);
        assertThat(testClient.getPaid()).isEqualTo(UPDATED_PAID);
        assertThat(testClient.getValided()).isEqualTo(UPDATED_VALIDED);
    }
